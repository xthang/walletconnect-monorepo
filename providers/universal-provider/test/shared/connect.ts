import { EngineTypes, PairingTypes, RelayerTypes, ProposalTypes, SessionTypes } from '@walletconnect/types'
import { parseUri } from '@walletconnect/utils'
import { expect } from 'vitest'
import UniversalProvider from '../../src/UniversalProvider'
import { TEST_RELAY_OPTIONS, TEST_NAMESPACES, TEST_REQUIRED_NAMESPACES, TEST_OPTIONAL_NAMESPACES } from './constants'
